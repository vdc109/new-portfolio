        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              A student who is passionate about STEM and technology and curious to learn about all aspects of the world. 
              I love playing and watching sports, especially football ⚽. My other hobbies are watching films 🎬, online FPS games 🔫, listening to music 🎵, and playing the guitar 🎸.
            </p>
...
const educationInfo = [
  {
    ...
    subTitle: "Florida State University | 2023 - Present",
    list: [
      "Studied computer science, software development theory and applied mathematics",
      "Worked as an ACE academic tutor in Mathematics and Computer Science courses",
      "Participated and mostly got 1st places in FSU ACM & ICPC regional competitions",
    ],
  },
  {
    id: 2,
    title: "Mathematics Honors Class",
    subTitle: "Hanoi Amsterdam High School for the gifted | 2020 - 2023",
    list: [
    ],
  }
];
