      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="overflow-hidden">
          <span className="text-animation text-2xl md:text-3xl lg:text-5xl block md:my-3 text-marrsgreen dark:text-carrigreen font-medium">
            An aspiring AI/ML Software Engineer
          </span>
        </div>
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a CS student with a passion for writing software products, learning new algorithms and models and about machine learning in general.
          </p>
          <p>
            I have experience in full-stack development, and I am currently exploring the world of AI and machine learning as well as learning more applied maths and data engineering to create predictive models.
          </p>
        </div>
      </div>
      <a
